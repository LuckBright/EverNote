    ...
    <div class="border">
      <el-form :inline="true" :model="form" size="mini">
        <el-form-item  label="" class="hei100" prop="surgeries">
          <shou-shu :value="value" @change="change"></shou-shu>
        </el-form-item>
        ...
        <el-form-item label="住院费用(元)"  :prop="ZONG_FEI_YONG">
          总费用
          <div class="wid240 inline">
        ...
        <el-form-item label="1.综合医疗服务类" class="mt10"  :prop="YI_BAN_YI_LIAO_FEI">
          (1)一般医疗服务费
        ...
        <el-form-item label="2.诊断类" class="mt10" :prop="BING_LI_ZHEN_DUAN_FEI">
          (5)病理诊断费
          <div class="wid120 inline">
        ...
        <el-form-item label="3.治疗类"  :prop="FEI_SHOU_SHU" class="mt10">
          (9)非手术治疗项目费
          <div class="wid120 inline">
        ...
        <el-form-item label="4.康复类" :prop="KANG_FU_FEI">
          (11)康复费
        ...
        <el-form-item label="5.中医类"  :prop="ZHONG_YI_ZHI_LIAO">
          (12)中医治疗费
          <div class="wid450 inline">
            <m-input :value="value" :prop="ZHONG_YI_ZHI_LIAO" @change="change"></m-input>
          </div>
        </el-form-item>
        <el-form-item label="6.西药类"  :prop="XI_YAO">
          (13)西药费
          <div class="wid120 inline">
        ...
        <el-form-item label="7.中药类"  :prop="ZHONG_CHENG_YAO">
          (14)中成药费
          <div class="wid120 inline">
        ...
        <el-form-item label="8.血液和血液制品类"  :prop="XUE_FEI" class="mt10">
          (16)血费
        ...
        <el-form-item label="9.耗材类" :prop="JIAN_CHA_YI_CI" class="mt10">
          (21)检查用一次性医用材料费
          <div class="wid100 inline">
        ...
        <el-form-item label="10.其他类"  :prop="QI_TA_FEI">
          (24)其他费
          <div class="wid100 inline">
...
import mTime from '@/components/medicalindex/mtimes'
