<template>
  <div class="chuyuan">
    <el-table class="noborder" :data="tableData" :span-method="arraySpanMethod">
      <el-table-column label="出院诊断" width="293">
      ...
      <el-table-column label="入院病情" width="35">
        <template slot-scope="scope">
      ...
      <el-table-column prop="date" label="出院诊断" width="292">
        <template slot-scope="scope">
      ...
      <el-table-column width="35" label="入院病情">
        <template slot-scope="scope">
