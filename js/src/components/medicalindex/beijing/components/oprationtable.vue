    ...
    <el-table class="noborder"
      ...
      <el-table-column prop="name"
        ...
        <el-table-column prop="name"
                         ...
                         label="术者">
          <template slot-scope="scope">
            <m-person :value="scope.row"
                      :index="scope.$index"
                      @change="changeShuZhe"
                      :prop="SHU_ZHE"
                      :dpt-id="dptId"
                      :type="['DOCTOR']"></m-person>
          </template>
        </el-table-column>
        <el-table-column prop="name"
                         width="80"
...
export default {
  ...
  methods: {
    ...
    changeShuZhe(prop, item, index) {
      this.change(this.SHU_ZHE, item.name, index)
      this.change(this.SHU_ZHE_CODE, item.code, index)
    },
    changeMaZuiDoctor(prop, item, index) {
      this.change(this.MA_ZUI_SHI, item.name, index)
      this.change(this.MA_ZUI_SHI_CODE, item.code, index)
    },
    changeYiZhu(prop, item, index) {
      this.change(this.YI_ZHU, item.name, index)
      this.change(this.YI_ZHU_CODE, item.code, index)
    },
    changeErZhu(prop, item, index) {
      this.change(this.ER_ZHU, item.name, index)
      this.change(this.ER_ZHU_CODE, item.code, index)
    },
    changeLevel(item, index) {
      this.change(this.YU_HE_DENG_JI, item.code, index)
      this.change(this.YU_HE_DENG_JI_VALUE, item.value, index)
    },
