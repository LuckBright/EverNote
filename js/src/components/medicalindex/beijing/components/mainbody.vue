...
export default {
  ...
  methods: {
    changeValue (key, val) {
      // 进修医师。实习医师，编码员
      let keys = ['HDSD00_11_054', 'HDSD00_11_088', 'HDSD00_11_005']
    ...
    changeBingli2 (item) {
      this.changeValue(keyMap.BING_LI_NAME2, item.diseaseName)
      this.changeValue(keyMap.BING_LI_CODE2, item.diseaseCode)
    }
  },
  components: {
    mSys,
