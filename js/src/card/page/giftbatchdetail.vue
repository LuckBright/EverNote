      ...
      <div class="panel-body">
        ...
        <el-table :data="tableData" border>
          ...
          <el-table-column prop="origPrice" label="面额">
            <template slot-scope="scope">{{money}} 元</template>
          </el-table-column>
...
<script>
import api from '../store/giftbatchdetailapi'
import giftbatch from '../store/giftbatchapi'
...
export default {
  ...
  created () {
    giftbatch.getById(this.queryObj.batchId).then((result) => {
